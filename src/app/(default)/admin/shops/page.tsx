...
export default async function AdminShopsPage() {
  ...
  const [shopsRes, badges] = await Promise.all([
    admin
      .from("shops")
  ...
  const { data: rows, error } = shopsRes;
  ...
  return (
    ...
    >
      ...
      <AdminPanel>
        <h2 className="text-base font-semibold text-v2-ink">새 가게 만들기</h2>
              ...
              <li key={s.id}>
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-2 text-xs">
                    <AdminPill>{s.is_public ? "공개" : "비공개"}</AdminPill>
