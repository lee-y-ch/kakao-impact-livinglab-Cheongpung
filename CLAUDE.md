...
`[2026] 강화유니버스 프로젝트 개요.pdf` 기준.

1. **환대의 공유지 (commons)** — 강화도 안의 공유 자원·공간·관계를 잇는 프로젝트
2. **환대의 네트워크 (network)** — 강화 안팎의 사람과 조직을 연결하는 교류·협업
3. **환대의 세계 (world)** — 환대의 정신을 담은 콘텐츠·브랜드·작품
4. **환대의 정책 (policy)** — 환대 관점으로 지역 정책·제도·공론을 제안
